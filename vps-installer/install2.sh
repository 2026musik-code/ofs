            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        <!-- Only pass UUID, not PIN -->
                        <button onclick="openLinkModal('<?php echo $u['uuid']; ?>')" style="padding: 5px 10px; width: auto; font-size: 0.8rem; background: #333; color: #fff; border: 1px solid #555;">View Config</button>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
